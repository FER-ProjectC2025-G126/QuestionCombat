...
const Public = () => {
    ...
    useEffect(() => {
        api.get("/public/question_sets").then((response) => {
  ...
  return (
    <div className="container">
            ...
            <div id= "q3" className="falling-question" style={{ left: '85vw' }}>?</div>
            <div id ="q4"className="falling-question" style={{ left: '95vw' }}>?</div>
