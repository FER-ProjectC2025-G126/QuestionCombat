      ...
      <div className="block">
        ...
        <div className="board">
          {appState.capacity > 1 ? (
            ...
            <div key={appState.lastGameStats[0].username}>
              <p>{appState.lastGameStats[0].username}</p>
              <span className="playerScore">{appState.lastGameStats[0].score}</span>
              <p>
                {appState.lastGameStats[0].correctAns} /{' '}
                {appState.lastGameStats[0].correctAns + appState.lastGameStats[0].incorrectAns}{' '}
                correct answers
              </p>
            </div>
          )}
